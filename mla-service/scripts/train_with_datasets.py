...
def train_with_real_datasets(
    ...
    Args:
        ...
        skip_registry: Skip uploading to MinIO registry
    """
    ...
    if skip_registry:
        logger.info("  Skipping MinIO registry upload (--skip-registry flag)")
    else:
        try:
            ...
            if registry.is_available():
                ...
                logger.info(f"  ✓ Uploaded to registry as version: {version}")
            else:
